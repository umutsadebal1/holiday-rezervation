...
const antalya_hotels = [
    {
        ...
        rating: 4.8,
        price: 1850,
        features: ['Sahil Kenarı', '5 Restoran', 'Spa', 'Kapalı Havuz']
    },
    {
        name: 'Titanic Deluxe Beach',
        image: 'img/90.jpg',
        rating: 4.7,
        price: 1650,
        features: ['All-Inclusive', 'Animasyon', 'Su Parkı', 'Konsiyerj']
    },
    {
        name: 'Kémer Luxury Hotels',
        image: 'img/91.jpg',
        rating: 4.6,
        price: 1450,
        features: ['Dağ Manzarası', 'Private Plaj', 'Yoga', 'Kütüphane']
    },
    {
        ...
        rating: 4.5,
        price: 1200,
        features: ['Antik Şehir Yakın', 'Balık Restoranı', 'Masaj', 'Kino']
    },
    {
        ...
        rating: 4.4,
        price: 980,
        features: ['Ailelere Uygun', 'Çocuk Kulübü', 'Oyun Parkı', 'Beslenme']
    },
    {
        name: 'Marina Resort Antalya',
        image: 'img/94.jpg',
        rating: 4.3,
        price: 1100,
        features: ['Modern Mimari', 'Teknoloji', 'Business Merkezi', 'Uydu TV']
    },
    {
        ...
        rating: 4.6,
        price: 750,
        features: ['Tarih Başıboş', 'Eski Şehir', 'Çay Saati', 'Rehber']
    },
    {
        ...
        rating: 4.9,
        price: 2200,
        features: ['Kasırgalar Sahili', 'Sunset Bar', 'Gourmet', 'Helikopter']
    }
];

function loadHotels() {
    const grid = document.getElementById('hotelsGrid');
    grid.innerHTML = antalya_hotels.map(hotel => `
