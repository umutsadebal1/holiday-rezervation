...
const izmir_hotels = [
    {
        ...
        rating: 4.8,
        price: 1650,
        features: ['5 Yıldız', 'Kordon', 'Business', 'Spa']
    },
    {
        name: 'Çeşme Beach Resort',
        image: 'img/97.jpg',
        rating: 4.7,
        price: 1450,
        features: ['Sahil', 'Windsurf', 'Beach Club', 'Nightlife']
    },
    {
        name: 'Alaçatı Boutique Hotel',
        image: 'img/96.jpg',
        rating: 4.9,
        price: 1850,
        features: ['Butik', 'Taş Evler', 'Rüzgar Sörfü', 'Şarap']
    },
    {
        ...
        rating: 4.6,
        price: 1200,
        features: ['Yat Limanı', 'Deniz Manzarası', 'Restaurant', 'Bar']
    },
    {
        name: 'Bergama Historical Inn',
        image: 'img/94.jpg',
        rating: 4.4,
        price: 780,
        features: ['Antik Kent', 'Arkeoloji', 'Müze', 'Kültür Turu']
    },
    {
        name: 'Foça Seaside Resort',
        image: 'img/100.jpg',
        rating: 4.5,
        price: 950,
        features: ['Sahil Kasabası', 'Balık', 'Dalış', 'Tekne Turu']
    },
    {
        name: 'Urla Bağ Evi',
        image: 'img/101.jpg',
        rating: 4.8,
        price: 1550,
        features: ['Bağlar', 'Şarap Tadımı', 'Organik Yemek', 'Sanat']
    },
    {
        name: 'Kordon Luxury Suites',
        image: 'img/102.jpg',
        rating: 4.9,
        price: 2100,
        features: ['Lüks', 'Deniz Manzarası', 'Penthouse', 'Concierge']
    }
];

function loadHotels() {
    const grid = document.getElementById('hotelsGrid');
    grid.innerHTML = izmir_hotels.map(hotel => `
        <div class="hotel-card">
            <img src="${hotel.image}" alt="${hotel.name}" onerror="this.src='img/98.jpg'">
