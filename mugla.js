...
const mugla_hotels = [
    {
        name: 'Marmaris Grand Resort',
        image: 'img/72.jpg',
        rating: 4.7,
        price: 1350,
        features: ['All-Inclusive', 'Aquapark', 'Beach', 'Animation']
    },
    {
        ...
        rating: 4.8,
        price: 1650,
        features: ['Sahil', 'Yat Turu', 'Gece Hayatı', 'Spa']
    },
    {
        name: 'Datça Peninsula Lodge',
        image: 'img/91.jpg',
        rating: 4.6,
        price: 980,
        features: ['Sakin', 'Doğa', 'Badem Ağaçları', 'Yoga']
    },
    {
        name: 'Fethiye Butterfly Valley',
        image: 'img/92.jpg',
        rating: 4.9,
        price: 850,
        features: ['Kamp', 'Trekking', 'Şelale', 'Doğa']
    },
    {
        ...
        rating: 4.8,
        price: 1450,
        features: ['Lagün', 'Yamaç Paraşütü', 'Beach', 'Water Sports']
    },
    {
        name: 'Köyceğiz Lake Hotel',
        image: 'img/94.jpg',
        rating: 4.5,
        price: 750,
        features: ['Göl', 'Tekne Turu', 'Termal', 'Kaplıca']
    },
    {
        name: 'Dalyan River Resort',
        image: 'img/95.jpg',
        rating: 4.7,
        price: 1100,
        features: ['Nehir', 'Caretta Plajı', 'Kaya Mezarları', 'Tekne']
    },
    {
        name: 'Muğla Castle View',
        image: 'img/96.jpg',
        rating: 4.4,
        price: 650,
        features: ['Tarihi', 'Şehir Merkezi', 'Otopark', 'Restaurant']
    }
];

function loadHotels() {
    const grid = document.getElementById('hotelsGrid');
    grid.innerHTML = mugla_hotels.map(hotel => `
        <div class="hotel-card">
            <img src="${hotel.image}" alt="${hotel.name}" onerror="this.src='img/72.jpg'">
